...
static const _ComputerInfo_type_support_symbol_names_t _ComputerInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, exercices, msg, ComputerInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, exercices, msg, ComputerInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, exercices, msg, ComputerInfo)() {
  return &::exercices::msg::rosidl_typesupport_c::ComputerInfo_message_type_support_handle;
}
