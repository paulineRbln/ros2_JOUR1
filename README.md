...
- Sur un deuxième terminal  : après avoir build et source ```ros2 run exercices subscriber_ex1.py```
...
- Sur un deuxième terminal  : après avoir build et source  ```run exercices subscriber_ex2.py```
...
- Sur un deuxième terminal  : après avoir build et source ```ros2 run exercices subscriber_ex3.py```
...
- Sur un deuxième terminal  : après avoir build et source ```ros2 run exercices subscriber_ex4.py```
...
- Sur un troisième terminal  : après avoir build et source ```ros2 run exercices subscriber_ex5.py```
...
- Sur un deuxième terminal  : après avoir build et source ```ros2 run exercices node_client_ex7.py```
